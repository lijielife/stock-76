...
$reqpre = new db();
	...
	$tousselect = "td.tdselect0, ";
  	...
  	$texto .= "td.tdcrochet {height:5px;padding:1px;display:block;background-color:#FFFFFF;color:#000000;text-align:center;font-weight:bold;}\n";
    $texto .= "a.tdcrochet{padding:1px;display:block;text-decoration:none;color:#000;border:2px solid #000;background-color:#FFF;}\n";
...
$req = new db();
	...
	$texto .='<form name="prescription" method="POST" action="./save">
		Prescription actuelle dossier n&deg;  <b>'.$_POST['dossier'].'</b>
...
<th class=\"selecttorque\">crochet</th>
<td class='tdselect9' colspan='4' >&nbsp;</td>
<td class='tdselect9' ><a class='tdcrochet' href='javascript:crochetplus(13);'> C </a></td>
<td class='tdselect9' colspan='4'>&nbsp;</td>
<td class='tdselect9' ><a class='tdcrochet' href='javascript:crochetplus(23);'> C </a></td>
<td class='tdselect9' colspan='4' >&nbsp;</td>
<th class=\"selecttorque\">&nbsp;</th>
</tr>";
	...
	$lanature=$torq_cat->nature;
		...
		while($torq = $requi->row()){
			...
			$textito .="<td class=\"$laclasse\" $rajdedent><a class='$laclasse' href=\"#\" onclick='choostorq($torq->dent,\"".$torq->valeur."\",$lidcateg,\"$lacolorfond\",\"$lacolortext\",\"$lanature\",\"".$torq->produit_id."\");'>$torq->valeur</a></td>\n";
