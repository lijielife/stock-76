...
for ($i=17; $i > 10 ; $i--) {
	...
	$texto .="<span class=\"lesdents\" id=\"$presq->produit_id\"  style=\"width:40px;display:block;padding-right:3px;padding-left:3px;margin:1px;color:#eee;background-color:#fff;border:2px solid #eee;\">$i</span><span style='font-size:12px'>&nbsp;</span></td>\n";
	}
}
