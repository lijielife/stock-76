...
switch($_POST['action']){
	...
	//sav les infos
	$req = new db();
	$saving= "INSERT INTO torq_categ VALUES('', '" .$_POST["categ"] ."', '".$_POST["backcolor"] ."', '".$_POST["textcolor"] ."', '".$_POST["nature"] ."', '".$_POST["classement"] ."')";
...
$req = new db();
$saving = "UPDATE torq_categ SET categ='" .$_POST["categ"] ."', backgroundcolor='".$_POST["backcolor"] ."', textcolor='".$_POST["textcolor"] ."', nature='".$_POST["nature"] ."', classement='".$_POST["classement"] ."' WHERE id_torq_categ='".$_POST["id_torq_categ"] ."'";
$req->findupdate($saving);
...
for ($i=31; $i < 38 ; $i++) {
	...
	break;
	case "efftorque";
	$test = $ret->delete('torq_categ', $_POST['lid']);
	$ret->findupdate("DELETE FROM torque where categ=".$_POST['lid']);
	$mess ="effacetorq";
	$page = "option";
	break;
	default;
