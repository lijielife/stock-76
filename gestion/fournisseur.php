...
switch($action){
	...
	<label for=\"email_cmd\">Email de commande : </label><input class=\"actif\" type=\"text\" name=\"email_cmd\" value=\"\" id=\"email_cmd\"><br />
	...
	<label for=\"email_cmd\">Email de commande : </label><input class=\"actif\" type=\"text\" name=\"email_cmd\" value=\"$lefourn->email_cmd\" id=\"email_cmd\"><br />	
